...
import com.automationexercise.utils.TerminalUtil;
...
public class AllureReportGenerator {
    ...
    public static void generateReports(boolean isSingleFile) {
        ...
        TerminalUtil.executeTerminalCommand(command.toArray(new String[0]));
    }
    ...
    public static void openReport(String reportFileName) {
        ...
        switch (OSUtils.getCurrentOS()) {
            case WINDOWS -> TerminalUtil.executeTerminalCommand("cmd.exe", "/c", "start", reportPath.toString());
            case MAC, LINUX -> TerminalUtil.executeTerminalCommand("open", reportPath.toString());
